...
export default function KanbanPage() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const contactsResponse = await fetch(`${CRM_WHATSAPP_API_BASE}/contacts?channelId=${channelId}`);
      ...
      const conversationsResponse = await fetch(`${CRM_WHATSAPP_API_BASE}/conversations?channelId=${channelId}`);
