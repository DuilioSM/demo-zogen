...
export default function VentasAseguradorasPage() {
      ...
      if (key && key.startsWith('admin-solicitud-')) {
        ...
        if (data) {
          try {
            ...
            // Filtrar solo solicitudes aprobadas con método de pago aseguradora
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-purple-100/30 to-white p-6">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Ventas Aseguradoras</h1>
          <p className="text-gray-600 mt-2">
            Facturación, timbrado y cobranza de servicios con aseguradoras
          </p>
        </div>
